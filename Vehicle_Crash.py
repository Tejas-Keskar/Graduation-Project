...
def cvDrawBoxes(detections, img):
    ...
    #=================================================================            	
        ...
        for (id1, p1), (id2, p2) in combinations(centroid_dict.items(), 2): # Get all the combinations of close detections, #List of multiple items - id1 1, points 2, 1,3
            ...
            #if distance < 20.0:						# Set our distance threshold - If they meet this condition then..
...
def YOLO():
	...
	sql = "INSERT INTO email (mail) VALUES (%s)"
	val = (mail1)
	...
	#cap = cv2.VideoCapture("carcrash.mp4")                                # Uncomment for Local Stored video detection - Set input video

	url = "https://www.youtube.com/watch?v=vJLBqiyeMP0"                 # Uncomment these lines for video from youtube
	video = pafy.new(url)
