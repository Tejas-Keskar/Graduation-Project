...
def YOLO():
    ...
    #cap = cv2.VideoCapture("socialdistence2.mp4")                     # Uncomment for Local Stored video detection - Set input video
    
    url = "https://www.youtube.com/watch?v=ORrrKXGx2SE"                 # Uncomment these lines for video from youtube
    video = pafy.new(url)
    ...
    #print("Video Reolution: ",(new_width, new_height))
